...
public:
    ...
    static VkResult getExtensionProperties(LayerProperties& layerProps, VkPhysicalDevice* gpu = VK_NULL_HANDLE);
...
public:
    ...
    VkDebugReportCallbackCreateInfoEXT m_dbgReportCreateInfo{};
