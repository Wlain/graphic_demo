...
{
GLuint ShaderUtil::CreateProgram(GLuint vertShader, GLuint fragShader)
{
    GLuint program = 0;
...
GLuint ShaderUtil::CompileShader(GLenum shaderType, const GLchar* src)
{
...
ShaderUtil::ShaderUtil(const char* vertexPath, const char* fragmentPath)
{
    ...
    {
        std::cout << "ERROR::ShaderUtil::file not successfully read" << std::endl;
    }
...
void ShaderUtil::setVector2(const std::string& name, const glm::vec2& value) const
{
    glUniform2fv(glGetUniformLocation(mProgram, name.c_str()), 1, &value[0]);
}

void ShaderUtil::setVector2(const std::string& name, float x, float y) const
{
    glUniform2f(glGetUniformLocation(mProgram, name.c_str()), x, y);
}

void ShaderUtil::setVector3(const std::string& name, const glm::vec3& value) const
{
    glUniform3fv(glGetUniformLocation(mProgram, name.c_str()), 1, &value[0]);
}

void ShaderUtil::setVector3(const std::string& name, float x, float y, float z) const
{
    glUniform3f(glGetUniformLocation(mProgram, name.c_str()), x, y, z);
}

void ShaderUtil::setVector4(const std::string& name, const glm::vec4& value) const
{
    glUniform4fv(glGetUniformLocation(mProgram, name.c_str()), 1, &value[0]);
}

void ShaderUtil::setVector4(const std::string& name, float x, float y, float z, float w) const
{
    glUniform4f(glGetUniformLocation(mProgram, name.c_str()), x, y, z, w);
}

void ShaderUtil::setMatrix2(const std::string& name, const glm::mat2& mat) const
{
    glUniformMatrix2fv(glGetUniformLocation(mProgram, name.c_str()), 1, GL_FALSE, &mat[0][0]);
}

void ShaderUtil::setMatrix3(const std::string& name, const glm::mat3& mat) const
{
    glUniformMatrix3fv(glGetUniformLocation(mProgram, name.c_str()), 1, GL_FALSE, &mat[0][0]);
}

void ShaderUtil::setMatrix4(const std::string& name, const glm::mat4& mat) const
{
